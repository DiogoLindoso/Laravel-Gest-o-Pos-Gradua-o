...
$factory->define(Documento::class, function (Faker $faker) {
    ...
    $title = array('Sr. ', 'Dr. ', 'Sra. ', 'Srta. ', 'Dr. ');
    return [
        'nome' => str_replace($title, '', $faker->name($sexo[$rand][1])),
        'sexo' => $sexo[$rand][0],
        'cpf' => $faker->cpf(false),
        'nome_mae' => str_replace($title, '', $faker->name('female')),
        'nome_pai' => str_replace($title, '', $faker->name('male')),
